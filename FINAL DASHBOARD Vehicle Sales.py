...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata, x='Year', y='Automobile_Sales', labels={'Year': 'Year', 'Automobile_Sales': 'Average Automobile Sales'}, title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                values=exp_rec.values,
                names=exp_rec.index,
                title='Total expenditure share by vehicle over Years'
            )
        )
